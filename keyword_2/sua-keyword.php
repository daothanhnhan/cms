<?php 
	...
	function keyword ($id) {
      ...
      if ($check_0 == 0 && $check_1 == 0 && $check_2 == 0 && $check_3 == 0) {
        $check_name = 0;
			...
			$sql = "UPDATE keyword_2 SET name = '$name', domain = '$domain', domain1 = '$domain1', domain2 = '$domain2', domain3 = '$domain3', check_name = $check_name, check_0 = $check_0, check_1 = $check_1, check_2 = $check_2, check_3 = $check_3 WHERE id = $id";
  ...
  $info = $action->getDetail('keyword_2', 'id', $_GET['id']);
?>
