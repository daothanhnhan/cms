<?php 
  ...
  $action = new action();
  $list_keyword = $action->getList('keyword_2', '', '', 'id', 'asc', '', '', '');//var_dump($list_gmail);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="container">
  <h2>Các từ khóa</h2>
  <h3><a href="/keyword_2/them-keyword.php">Thêm</a></h3>          
  <table class="table">
    <thead>
      <tr>
        <th>STT</th>
    ...
    ?>
      <tr>
        ...
        <td><a href="/keyword_2/sua-keyword.php?id=<?= $item['id'] ?>">Sửa</a> | <a href="/keyword_2/xoa-keyword.php?id=<?= $item['id'] ?>" onclick="return confirm('Bạn chắc chắn muốn xóa.')">Xóa</a></td>
