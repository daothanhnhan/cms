	...
	function keyword () {
      ...
      if ($check_0 == 0 && $check_1 == 0 && $check_2 == 0 && $check_3 == 0) {
        $check_name = 0;
			...
			$sql = "INSERT INTO keyword_2 (name, domain, domain1, domain2, domain3, check_name, check_0, check_1, check_2, check_3) VALUES ('$name', '$domain', '$domain1', '$domain2', '$domain3', $check_name, $check_0, $check_1, $check_2, $check_3)";
			$result = mysqli_query($conn_vn, $sql);
			if ($result) {
				echo '<script type="text/javascript">alert(\'Bạn nhập từ khóa thành công.\');window.location.href="/keyword_2"</script>';
			} else {
...
<div class="container">
  <h2>Thêm Từ khóa</h2>
  <h3><a href="/keyword_2">Quay lại</a></h3>
