<?php 
	...
	function gmail () {
		...
		if (isset($_POST['add'])) {
			...
			$sql = "INSERT INTO gmail (email, password) VALUES ('$email', '$pass')";
			$result = mysqli_query($conn_vn, $sql);
			if ($result) {
				echo '<script type="text/javascript">alert(\'Bạn nhập gmail thành công.\');window.location.href="/gmail"</script>';
			} else {
