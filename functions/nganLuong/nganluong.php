...
<div class="gb-chonphuongthucthanhtoan">
    ...
    <form  name="NLpayBank" action="#" method="post" id="nganluong">
        ...
        <div class="form-group">
            <label>Họ Tên:	</label>
            <input type="text" id="fullname" name="buyer_fullname" class="field-check  form-control" value="" required>
        </div>
        <div class="form-group">
            <label>Email:	</label>
            <input type="text" id="fullname" name="buyer_email" class="field-check  form-control" value="" required>
        </div>
        <div class="form-group">
            <label for="">Số Điện thoại:	</label>
            <input type="text"  id="fullname" name="buyer_mobile" class="field-check form-control" value="" required>
        </div>
