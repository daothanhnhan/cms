...
class Pagination
{
    ...
    private function __link_cms($page, $link)
    {
        // Nếu trang < 1 thì ta sẽ lấy link first
        if ($page <= 1 && $this->_config['link_first']){
            return $this->_config['link_first'];
        ...
        // $page;
         if ($this->_config['search'] == '') {
            return '/list-file/'.$link.'/'.$page;
        } else {
            return '/list-file/'.$link.'/'.$page.'/'.$this->_config['search'];
        }
    ...
    {   
        ...
        if ($this->_config['total_record'] > $this->_config['limit'])
        {
            ...
            if ($this->_config['current_page'] > 1)
            {
                $p .= '<li><a href="'.$this->__link_cms('1', $link).'">First</a></li>';
                $p .= '<li><a href="'.$this->__link_cms($this->_config['current_page']-1, $link).'">Prev</a></li>';
            }
            ...
            for ($i = $this->_config['min']; $i <= $this->_config['max']; $i++)
            {
                ...
                if ($this->_config['current_page'] == $i){
                    ...
                    $p .= '<li><a href="'.$this->__link_cms($i, $link).'">'.$i.'</a></li>';
                }
            }
            ...
            if ($this->_config['current_page'] < $this->_config['total_page'])
            {
                $p .= '<li><a href="'.$this->__link_cms($this->_config['current_page'] + 1, $link).'">Next</a></li>';
                $p .= '<li><a href="'.$this->__link_cms($this->_config['total_page'], $link).'">Last</a></li>';
            }
