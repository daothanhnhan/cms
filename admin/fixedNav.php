    ...
    <div class="contentFL">
        <ul class="listMenuFL">
           ...
           <li><a href="index.php?page=danh-muc-dich-vu" title=""
            ...
            <li><a href="index.php?page=ma-giam-gia" title=""
                   class="linkMenu <?php if ($_GET["page"] == 'ma-giam-gia' || $_GET["page"] == 'them-ma-giam-gia' || $_GET["page"] == 'sua-ma-giam-gia') {
                       echo 'sltMenu';
                   } ?>"><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Mã giảm giá</a>
            </li>
    ...
    <div class="rightFixedTop">
        ...
        if (isset($_GET["page"])) {
            switch ($_GET["page"]) {
                ...
                case "ma-giam-gia":
                    echo "<a href='index.php?page=them-ma-giam-gia' class='btnTop btnAddTop'>Thêm Mới</a>";
                    break;

                case "sua-ma-giam-gia":
                    echo "<a href='index.php?page=them-ma-giam-gia' class='btnTop btnAddTop'>Thêm Mới</a>";
                    break;

                // case "mau-san-pham":
                //     echo "<a href='index.php?page=them-mau' class='btnTop btnAddTop'>Thêm Mới</a>";
                //     break;
