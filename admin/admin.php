        ...
        <div class="coverWeb">
            ...
            if (isset($_GET["page"])) {
                switch ($_GET["page"]) {
                    ...
                    ////////////// ma giam gia /////////////
                    case "ma-giam-gia":
                        include_once("template/ma-giam-gia/ma-giam-gia.php");
                        break;

                    case "them-ma-giam-gia":
                        include_once("template/ma-giam-gia/them-ma-giam-gia.php");
                        break;

                    case "sua-ma-giam-gia":
                        include_once("template/ma-giam-gia/sua-ma-giam-gia.php");
                        break;

                    case "xoa-ma-giam-gia":
                        include_once("template/ma-giam-gia/xoa-ma-giam-gia.php");
                        break;
                    /////////////// mau san pham //////////
                    case "them-mau":
