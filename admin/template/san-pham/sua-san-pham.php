<?php 
    ...
    $producttag_arr = explode(',', $row['producttag_arr']);
    $size_pro = json_decode($row['product_size']);
    $color_pro = json_decode($row['product_color']);
    $price_sub_pro = json_decode($row['product_price_sub']);
    $product_material = json_decode($row['product_material']);
?>
                            ...
                            <?php 
                                ...
                                ?>
                                    ...
                                    <div role="tabpanel" class="tab-pane <?= $key == 0 ? 'active' : ''?>" id="<?= $lang['languages_code']?>">
                                        ...
                                        <input type="text" class="txtNCP1" value="<?= $rowDetailLang['lang_product_name'];?>" name="lang[<?= $lang['languages_code']?>][lang_product_name]"/>
                                        ...
                                        <textarea class="longtxtNCP1" name="lang[<?= $lang['languages_code']?>][des_seo]" ><?= $rowDetailLang['des_seo'];?></textarea>
...
<form action="" method="post" enctype="multipart/form-data" id="updateProduct">
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
           ...
           <?php 
            ...
            <p class="titleRightNCP">Tặng phẩm đi kèm</p>
            <select name="product_gift_id" class="txtNCP1">
                <option value="0">Chọn tặng phẩm</option>
                <?php foreach ($list_product_gift as $item) { ?>
                <option value="<?= $item['product_id'] ?>" <?= ($row['product_gift_id']==$item['product_id']) ? 'selected' : '' ?>><?= $item['product_name'] ?></option>
                <?php }  ?>
            </select>
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="leftNCP">
            ...
            <span class="titLeftNCP">Quản lý màu sắc</span>
        ...
        <div class="boxNodeContentPage">
            ...
            <button type="button" onclick="add_color()">Thêm</button>

            <div class="rowNCP">

                <div class="subColContent">

                    <p class="titleRightNCP">Màu sắc</p>
                    <div id="color">
                        <?php foreach ($color_pro as $item) { ?>
                        <div class="del-input">
                            <input type="text" class="txtNCP1" value="<?php echo $item;?>" name="product_color[]"/>
                            <button type="button" onclick="del_color(this)">Xóa</button>
                        </div>
                        <?php } ?>         
                    </div>                    
    ...
    <script type="text/javascript">
        function add_color () {
            ...
            document.getElementById('color').innerHTML = size + '<div class="del-input"><input type="text" class="txtNCP1" value="" name="product_color[]"/><button type="button" onclick="del_color(this)">Xóa</button></div>';
        }
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="leftNCP">
            ...
            <span class="titLeftNCP">Quản lý Giá phụ Cùng chất liệu</span>
        ...
        <div class="boxNodeContentPage">
            ...
            <button type="button" onclick="add_price()">Thêm</button>

            <div class="rowNCP">

                <div class="subColContent">

                    <p class="titleRightNCP">Giá phụ</p>
                    <div id="price_sub">
                        <?php foreach ($price_sub_pro as $k => $item) { ?>
                        <div class="del-input">
                            <input type="number" class="txtNCP1" value="<?php echo $item;?>" name="product_price_sub[]" placeholder="Giá" />
                            <input type="text" class="txtNCP1" value="<?php echo $product_material[$k];?>" name="product_material[]" placeholder="Chât liệu" />
                            <button type="button" onclick="del_price(this)">Xóa</button>
                        </div>
                        <?php } ?>         
                    </div>                    
    ...
    <script type="text/javascript">
        function add_price () {
            ...
            document.getElementById('price_sub').innerHTML = size + '<div class="del-input"><input type="number" class="txtNCP1" value="" name="product_price_sub[]" placeholder="Giá" /><input type="text" class="txtNCP1" value="" name="product_material[]" placeholder="Chât liệu" /><button type="button" onclick="del_price(this)">Xóa</button></div>';
        }
        ...
        <div class="boxNodeContentPage">
            ...
            <div>
                <label class="selectCate">
                    <input type="checkbox" value="1" name="product_gift" <?= $row['product_gift'] == 1 ? 'checked' : '' ?>>Tặng phẩm
                </label>
            </div>
