...
<header>
    ...
    <div class="gb-header-banhatgiong">
                        ...
                        <div class="gb-header-top-banhatgiong-right">
                            <ul>
                                <li>
                                    ...
                                    ?>
                                        <a class="user" href="/thong-tin-ca-nhan"><i class="fa fa-user" aria-hidden="true"></i><?= $_SESSION['user_name_gbvn'] ?></a>
                                        <a class="logout" href="/logout" title=""><i class="fa fa-sign-out" aria-hidden="true"></i></a>
                                    <?php }else{ ?>
                                        <a class="user" href="/login"><i class="fa fa-lock" aria-hidden="true"></i> Tài khoản</a>
                                    <?php } ?>
                                </li>
                                <li><a href=""><i class="fa fa-heart" aria-hidden="true"></i> Yêu thích (0)</a></li>
                                <li><a href="/cart-payment"><i class="fa fa-usd" aria-hidden="true"></i> Thanh toán</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <!--HEADER between-->
        <div class="gb-header-between_banhatgiong">
            <div class="container">
                <div class="row">
                    <div class="col-md-3  col-sm-3">
                        <div class="gb-header-between_banhatgiong-logo">
                            <h1>
                                <a href=""><img src="/images/<?= $rowConfig['web_logo'] ?>" alt="" class="img-responisve"></a>
                            </h1>
                        </div>
                    </div>
        ...
        <!--HEADER BETWEEN-->
        <div class="gb-header-bottom_banhatgiong">
            <div class="container">
                <div class="row">
                    <div class="col-md-10">
                    ...
                    <div class="col-md-2">
                        <?php include DIR_CART."MS_CART_BANHATGIONG_0001.php";?>
                    </div>
                </div>
            </div>
        </div>
