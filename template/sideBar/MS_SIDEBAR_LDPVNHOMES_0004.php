<?php
    $banggia = new action_email();
    $banggia->lien_he();
?>
<div class="gb-chitiet_duan-landingpage-right_ldpvinhome">
    <form action="" method="post">
        ...
        <button class="btn btn-taibanggia" type="submit" name="lien_he">Tải bảng giá</button>
