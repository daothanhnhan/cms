    ...
    <div id="wrapper-container-cms" class="site-wrapper-container-cms">
        <div id="main-content-cms" class="site-main-cms-content-cms">
            <div class="site-content-area-cms">
                <main id="main" class="site-main-cms">

                    <?php include_once DIR_BREADCRUMS.'MS_BREADCRUM_0001.php';?>

                    <div class="uni-cart-cms-body-cms">
                                    ...
                                    <div class="table-responsive" id="order_table" style="width: 100%;">  
                                       <table class="table table-bordered" style="margin-bottom: 100px;">  
                                            ...
                                            <tr>  
                                                 ...
                                                 <td><?php echo $values["product_gift"]; ?></td>
...
<script>  
 $(document).ready(function(data){  
      $('.add_to_cart').click(function(){  
           ...
           {  
                $.ajax({  
                     url:"../functions/action_cart_tmp4.php",  
                     method:"POST",  
                     dataType:"json",  
                     data:{  
