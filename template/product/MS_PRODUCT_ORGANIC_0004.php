...
<div class="gb-chitiet_sanpham_sakura">
    <div class="gb-chitiet_sanpham_sakura-body">
        <div class="container">
            <div class="gb-chitiet_sanpham_sakura-left">

                <!--chi titest sản phẩm-->
                <div class="row">
                    <div class="col-md-6">
                        <div class="gb-chitiet_sanpham_sakura_left-img">
                    ...
                    <div class="col-md-6">
                        <div class="gb-chitiet_sanpham_sakura_left-info">
                            ...
                            <?php include DIR_CART."MS_CART_ORGANIC_0002.php";?>
                ...
                <!--realte product-->
                <?php include DIR_PRODUCT."MS_PRODUCT_ORGANIC_0005.php";?>
