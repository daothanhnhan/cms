...
<div class="gb-chitiet_sanpham_vyhofoco">
    <div class="gb-chitiet_sanpham_vyhofoco-body">
        <div class="container">
            <div class="gb-chitiet_sanpham_vyhofoco-left">

                <!--chi titest sản phẩm-->
                <div class="row">
                    <div class="col-md-6">
                        <div class="gb-chitiet_sanpham_vyhofoco_left-img">
                    ...
                    <div class="col-md-6">
                        <div class="gb-chitiet_sanpham_vyhofoco_left-info">
                            ...
                            <div class="price-outer-container">
                                <?php include DIR_PRODUCT."MS_PRODUCT_VYHOFOCO_0004.php";?>
                            </div>
                            <!--SỐ LƯỢNG VÀ ADD TO CART-->
                            <?php include DIR_CART."MS_CART_VYHOFOCO_0003.php";?>
                ...
                <!--realte product-->
                <?php include DIR_PRODUCT."MS_PRODUCT_VYHOFOCO_0008.php";?>
