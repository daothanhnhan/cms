    ...
    <div class="category-product-cms uni-product-wapper-cms">
        ...
        <div class="row">
            ...
            foreach ($rows['data'] as $row) {
                ...
                $list_color = listColor($row['product_id']);
            ?>
                        ...
                        <li>
                            <div class="wrapper">
                                <div class="feature-image">
                                    <a href="/<?= $rowLang1[$nameColUrlProduct_productLanguage] ?>" id="img_pro_<?= $row1['product_id'] ?>"><img class="wp-post-image img-responsive" src="/images/<?= $row1['product_img'] ?>" alt=""></a>
                                ...
                                <div class="stats">
                                    ...
                                    <div class="price-add-cart-cms">
                                        ...
                                        <div style="text-align: center;">
                                            ...
                                            <img src="/images/<?= $item['color_img'] ?>" width="30" height="30" color="<?= $item['color_id'] ?>" onclick="color(this, '<?= $row1['product_id'] ?>')">
                                            <?php } ?>
                                        </div>
          ...
          xhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
             var bien = this.responseText;
                // alert(bien);
                document.getElementById("img_pro_"+pro).innerHTML = bien;
            }
          };
          xhttp.open("GET", "/functions/ajax/color_cat.php?id="+id, true);
          xhttp.send();
    }
</script>