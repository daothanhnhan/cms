...
<div class="gb-single-blog_organic">
    <div class="container">
        <div class="row">
            <div class="col-md-8 gb-single-blog_organic-right">
                <div class="gb-single-blog_organic-right-img">
                    <img src="/images/<?= $row['news_images'] ?>" alt="" class="img-responsive">
                </div>
                <div class="gb-single-blog_organic-right-title">
                    <h2><?= $rowLang['lang_news_name'] ?></h2>
                </div>
                <div class="gb-single-blog_organic-right-info">
                    <ul>
                        <li><i class="fa fa-user" aria-hidden="true"></i><a href="#"> Admin</a></li>
                        <li><i class="fa fa-clock-o" aria-hidden="true"></i><a href="#"> <?= date('d-m-Y', strtotime($row['news_created_date']))  ?></a></li>
                        <li><i class="fa fa-folder-open-o" aria-hidden="true"></i><a href="#"> Kiến thức làm đẹp</a></li>
                        <li><i class="fa fa-comment-o" aria-hidden="true"></i><a href="#"> 5 comments</a></li>
                    </ul>
                </div>
                <div class="gb-single-blog_organic-right-text">
                    <?= $rowLang['lang_news_content'] ?>
                </div>

                <div class="gb-single-blog_organic-share">
                    <div class="row">
                        <div class="col-md-5 gb-single-blog_organic-share-left">
                            <ul>
                        ...
                        <div class="col-md-5 col-md-offset-2 gb-single-blog_organic-share-right">
                            <ul>
                ...
                <!--bình luận-->
                <?php include DIR_EMAIL."MS_EMAIL_ORGANIC_0002.php";?>

                <!--tin tức liên quan-->
                <?php include DIR_NEWS."MS_NEWS_ORGANIC_0006.php";?>
