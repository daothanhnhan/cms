   ...
   $(document).ready(function(data){  
      $('.btn_addCart').click(function(){  
         // var product_id = $(this).attr("id");
           ...
           var action = "add";
           var product = $('input[name=product_price_sub]:checked').val();
           var obj = JSON.parse(product);           
           var product_price = obj.price;
           var product_material = obj.material;
           // alert(product_material);return false;
           // var a = {a : 'a'};
           if(product_quantity > 0)  
           {                  
                 $.ajax({  
                     url:"/functions/ajax.php?action=add_cart2",  
                     method:"POST",  
                     dataType:"json",  
                     data:{  
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="gb-chitiet_sanpham_left-info">
                                    ...
                                    <?php include_once DIR_PRODUCT.'MS_PRODUCT_0021.php';?>
