...
<div class="gb-page-sanpham_organic">
    <div class="container">
        <div class="col-md-9">
            <?php include DIR_SEARCH."MS_SEARCH_ORGANIC_0001.php";?>
            <div class="row">
                <?php 
                    $d = 0;
        ...
        <div class="col-md-3">
            ...
            <?php include DIR_SIDEBAR."MS_SIDEBAR_ORGANIC_0006.php";?>
            <?php include DIR_SIDEBAR."MS_SIDEBAR_ORGANIC_0004.php";?>
            <?php include DIR_SIDEBAR."MS_SIDEBAR_ORGANIC_0005.php";?>
        </div>
    </div>
</div>
