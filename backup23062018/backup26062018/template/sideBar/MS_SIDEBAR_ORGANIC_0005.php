<div class="gb-product-sidebar-organic widget-sidebar">
    <aside class="widget">
        <h3 class="widget-title-sidebar-organic">Sản phẩm mới nhất</h3>
        <div class="widget-content">
            <div class="gb-newlist-details">
                <?php
                    $product = new action_product();
                    $list_product_sidebar = $product->getListProductNew_hasLimit(4);
                ...
                ?>
                    <div class="gb-product-sidebar_organic-item">
                        <div class="gb-product-sidebar_organic-item-img">
                            <a href="/<?= $rowLang1['friendly_url'] ?>">
                                <img src="/images/<?= $row1['product_img'] ?>" alt="review" class="img-responsive">
                            </a>
                        </div>
                        <div class="gb-product-sidebar_organic-item-info">
