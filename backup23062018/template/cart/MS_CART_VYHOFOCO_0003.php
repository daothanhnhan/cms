<div class="gb-chi-tiet-add-to-cart-vyhofoco">
    <form class="cart" method="post" enctype="multipart/form-data">
        <div class="quantity">
            <div class="form-group">
                ...
                <input type="hidden" name="price" id="product_price" value="<?php echo $row1['product_price']-($row['product_price']*($row1['product_price_sale']/100));?>">
            </div>
        </div>
