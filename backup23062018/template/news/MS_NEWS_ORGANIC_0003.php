<div class="gb-news-upfooter-home_organic">
    <div class="container">
        <div class="row">
             <?php
            ...
            ?>
            <div class="col-sm-4">
                <div class="gb-news-upfooter-home_organic-item">
                    <div class="gb-news-upfooter-home_organic-item-text">
                        <h5><a href="/<?= $item['friendly_url'] ?>"><?= $item['news_name'] ?></a></h5>
                        <h4><a href="/<?= $item['friendly_url'] ?>">OF'H Cosmetic</a></h4>
                    </div>
                    <div class="gb-news-upfooter-home_organic-item-img">
