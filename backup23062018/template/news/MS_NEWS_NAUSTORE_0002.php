    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 gb-single-blog_naustore-right">
                ...
                <div class="gb-single-blog_naustore-right-info">
                    <ul>
                        <li><i class="fa fa-user" aria-hidden="true"></i><a href="#"> Admin</a></li>
                        <li><i class="fa fa-clock-o" aria-hidden="true"></i><a href="#"> <?= date('d-m-Y', strtotime($row['news_created_date']))  ?></a></li>
                        <li><i class="fa fa-folder-open-o" aria-hidden="true"></i><a href="#"> Tin tức Nâu Store</a></li>
                ...
                <!--bình luận-->
                <?php include DIR_EMAIL."MS_EMAIL_NAUSTORE_0002.php";?>

                <!--tin tức liên quan-->
                <?php include DIR_NEWS."MS_NEWS_NAUSTORE_0003.php";?>

            </div>
            <div class="col-md-4 gb-blog-left">
                <?php include DIR_SIDEBAR."MS_SIDEBAR_NAUSTORE_0001.php";?>
                <?php include DIR_SIDEBAR."MS_SIDEBAR_NAUSTORE_0002.php";?>
                <?php include DIR_SIDEBAR."MS_SIDEBAR_NAUSTORE_0003.php";?>
            </div>
        </div>
    </div>
</div>