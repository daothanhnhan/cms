...
<div class="gb-chitiet_sanpham_xdshop">
    <div class="gb-chitiet_sanpham_xdshop-body">
        <div class="container">
            <div class="gb-chitiet_sanpham_xdshop-left">

                <!--chi titest sản phẩm-->
                <div class="row">
                    <div class="col-md-6">
                        <div class="gb-chitiet_sanpham_xdshop_left-img">
                    ...
                    <div class="col-md-6">
                        <div class="gb-chitiet_sanpham_xdshop_left-info">
                            ...
                            <?php include DIR_CART."MS_CART_XDSHOP_0003.php";?>

                            <div class="gb-divider"></div>
                            <!--SHARE-->
                            <?php include DIR_SOCIAL."MS_SOCIAL_XDSHOP_0002.php";?>
                ...
                <!--realte product-->
                <?php include DIR_PRODUCT."MS_PRODUCT_XDSHOP_0008.php";?>
