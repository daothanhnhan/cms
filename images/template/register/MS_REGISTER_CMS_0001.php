    ...
    function dangky () {
        ...
        if (isset($_POST['register'])) {
            ...
            if ($ok == "true") {
                ...
                $sql = "INSERT INTO user (name, email, password, time, ask) VALUES ('$name', '$email', '$pass', $time, '$ask')";
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="gb-register-cms-body">
                    ...
                    <p>Tạo tài khoản để hưởng trọn ưu đãi tại Spro: tích điểm nhận quà, chương trình tri ân dành cho
